  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4" dir="rtl">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-medium text-foreground">הדף לא נמצא</h2>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "י. אשל בטיחות | מערכת ניהול" },
      { name: "description", content: "מערכת ניהול פנימית לחברת י. אשל יועצי בטיחות בע\"מ" },
      { property: "og:title", content: "י. אשל בטיחות | מערכת ניהול" },
      { property: "og:description", content: "מערכת ניהול פנימית לחברת י. אשל יועצי בטיחות בע\"מ" },
