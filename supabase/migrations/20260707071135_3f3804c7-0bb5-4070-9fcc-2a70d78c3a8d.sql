...
-- Update documents category check constraint
...
-- Recreate storage.objects policies with the new bucket list
...
CREATE POLICY "Admins read knowledge files"
  ...
  USING (
    bucket_id IN ('general','technical_specs','historical_quotes','commissioner_directives','planning_building_regulations','israeli_standards','fire_service_objections')
